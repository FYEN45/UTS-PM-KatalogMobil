...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Des 2021 pada 08.26
...
-- Database: `hrd`
--
CREATE DATABASE IF NOT EXISTS `hrd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `hrd`;
...
INSERT INTO `pegawai` (`nik`, `nama_pegawai`, `jenis_kelamin`, `tgl_lahir`, `id_jabatan`, `foto`, `keterangan`) VALUES
(15060101, 'George Addison', 'L', '1987-06-03', 1, 'george_addison.png', 'Pimpinan Perusahaan'),
(15060501, 'Amanda Asher', 'P', '1990-02-15', 2, 'amanda_asher.png', '');
...
(1, 15060501, 'aasher', '0192023a7bbd73250516f069df18b500', 'Admin'),
(2, 15060101, 'gaddison', '0192023a7bbd73250516f069df18b500', 'Pegawai');
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15060102;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"car_catalog\",\"table\":\"users\"},{\"db\":\"sunlight_db\",\"table\":\"user\"},{\"db\":\"volley\",\"table\":\"products\"},{\"db\":\"sunlight_db\",\"table\":\"produk\"},{\"db\":\"hrd\",\"table\":\"user\"},{\"db\":\"hrd\",\"table\":\"pegawai\"},{\"db\":\"hrd\",\"table\":\"jabatan\"}]');
...
('root', '2021-12-06 07:19:14', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
--
CREATE DATABASE IF NOT EXISTS `sunlight_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sunlight_db`;
...
INSERT INTO `produk` (`kode_barang`, `nama_barang`, `stok_barang`, `harga_barang`) VALUES
('SAB', 'SUNLIGHT ANTI BAU', 0, 15000),
('SEP', 'SUNLIGHT EXTRA POWER', 0, 14000),
('SEPR', 'SUNLIGHT EXTRA PURE', 0, 18000),
('SHP', 'SUNLIGHT HIGIENIS PLUS', 0, 12500),
('SJN100', 'SUNLIGHT JERUK NIPIS 100', 0, 10000);
...
-- Database: `volley`
--
CREATE DATABASE IF NOT EXISTS `volley` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `volley`;
